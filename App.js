...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch(
        "https://dpsg10.000webhostapp.com/apiusuario.php?comando=autenticar&usuario=" +
          this.state.usuario +
          "&contrasena=" +
...
class listarProductos extends React.Component {
  ...
  cargarRegistros() {
    console.log("Prueba");
    fetch("https://dpsg10.000webhostapp.com/api.php?comando=listar", {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaDetalle extends React.Component {
  ...
  Actualizar() {
    fetch(
      "https://dpsg10.000webhostapp.com/api.php?comando=editar&direccion_postal=" +
  ...
  Eliminar() {
    fetch(
      "https://dpsg10.000webhostapp.com/api.php?comando=eliminar&id=" +
        this.state.id,
      {
        method: "GET",
      }
...
class PaginaAgregar extends React.Component {
  ...
  Guardar() {
    fetch(
      "https://dpsg10.000webhostapp.com/api.php?comando=agregar&direccion_postal=" +
        this.state.direccion_postal +
        "&direccion_trabajo=" +
        this.state.direccion_trabajo +
        "&email=" +
